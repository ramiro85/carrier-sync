...
class ELDDriverController:
    def __init__(self, base_url: str, authorization_token: str = None, eld_api=None):
        ...
        self.headers = {
            ...
            "priority": "u=1, i",
            "referer": f"{settings.eld_origin.rstrip('/')}/",
    ...
    def create_driver(
        self, driver_id: str, driver_data: DriverCreateRequest
    ) -> Dict[str, Any]:
        """
    ...
    def delete_driver(
        self, driver_id: str, rev: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def list_drivers(
        self, company_id: str, limit: int = 100, skip: int = 0
    ) -> Dict[str, Any]:
        """
